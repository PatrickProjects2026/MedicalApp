...
void main() {
  runApp(const pressRelease());
}

class pressRelease extends StatelessWidget {
  const pressRelease({super.key});
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> fetchData4() async {
    final response =
        await http.get(Uri.parse('https://cdn.adslive.com/pressRelease2'));
              ...
              Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    // Html(data: dbnews[1]["content"] ?? "invalid string"),
                                        ...
                                        Navigator.pushNamed(context, '/news_',
                                            arguments: {
                                              'title':
                                                  '${dbnews[index]["title"]}',
                                              'body':
                                                  '${dbnews[index]["content"]}',
                                              'time':
                                                  '${dbnews[index]["created_at"]}',
                                              'image':
                                                  '${dbnews[index]["image"]}',
                                            });
                                      },
