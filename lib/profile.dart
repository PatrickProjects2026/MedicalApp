...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _registerUser(uname_, pass_) async {
    final response = await http
        .get(Uri.parse('https://cdn.adslive.com/reg_user/${uname_}/${pass_}'));
  ...
  Future<void> _myFavorites() async {
    // String name = _sessionData;
    // if (name.isEmpty || name == "") {
    //   name = postname;
    // }
    // String name = postname;

    String url = "https://cdn.adslive.com/my_fav2/$postname";
    print("URL:$url");
    ...
    if (response.statusCode == 200) {
      final jsonData = json.decode(response.body);
      // print("favorites 1:${jsonData}");
      myFavorites = jsonData;
    }
  }
  // }
        ...
        body: Center(
            ...
            child: Column(
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    border:
                        Border.all(color: Color.fromARGB(255, 218, 217, 217)),
                  ),
                  child: myFavorites.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (index >= 0 && index < myFavorites.length) {
                              return Container(
                                  child: GestureDetector(
                                      ...
                                      child: row_2(
                                          ...
                                          "${myFavorites[index]["telephone"]}",
                                          "${myFavorites[index]["address"]}")));
                            }
                          },
                        )),
              Spacer()
  ...
  return Container(
    ...
    child: ElevatedButton(
      ...
      onPressed: () {
        ...
        } else if (where.text != confirm.text) {
          _showDialog(context, 'Password doesnt match.');
        } else {
...
Widget row_2(context, pic_, name_, number_, address_) {
  String logo_ = "uploads/logos/placeholder/logo.png";
  String path_ = "";

  if (pic_ == "null" || pic_ == "") {
    path_ = "https://cdn.adslive.com/$logo_";
  } else {
    path_ = "https://cdn.adslive.com/$pic_";
  }

  print("Final Logo:$path_");
  ...
  return Row(
    children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          number_.length > 30 ? number_.substring(0, 30) : number_,
          textAlign: TextAlign.left,
          style: TextStyle(
              fontWeight: FontWeight.bold, fontSize: 10, color: Colors.grey),
        ),
