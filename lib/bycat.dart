...
class bycat extends StatelessWidget {
  const bycat({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      routes: {'/view_company': (context) => const Company()},
      title: 'Flutter Demo',
      theme: ThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> fetchData3() async {
    final response =
        await http.get(Uri.parse('https://cdn.adslive.com/bymedcat/$catid'));
              ...
              Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Text(""),
                    title_(context, Icons.search,
                        " ${companies.length} Results for $catname "),
                    Container(
                        height: 550,
                        width: double.infinity,
  ...
  return Row(
    children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(
          address_.length > 20 ? address_.substring(0, 20) : address_,
          textAlign: TextAlign.left,
          style: TextStyle(
              fontWeight: FontWeight.bold, fontSize: 10, color: Colors.grey),
        )
